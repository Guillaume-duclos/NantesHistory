...
$('.up-scale').click(function(){
  ...
  $(this).parent().css('border-right', '0px');
  $(this).parent().siblings('.desc').css('width', '0%');
...
$('.up-scale-resp').click(function(){
  ...
  $(this).prev().children().addClass('height');
  $(this).prev().children().removeClass('img-doc-width');
});
...
function rescaleResp() {
  $('.img-doc-resp').parent().removeClass('height');
  $('.img-doc-resp').addClass('img-doc-width');
  $('.img-doc-resp').removeClass('height');
}

$('.screen:last-child .right-arrow').parent().css('display', 'none');
